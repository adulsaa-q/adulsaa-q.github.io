#!/usr/bin/env python3
"""
Generator script for Q Portfolio Master Redesign Audit & Strategic Blueprint.
Produces the comprehensive 26-section audit and saves it to:
1. /Users/q/Desktop/Q_PORTFOLIO_REDESIGN_MASTER_AUDIT.md
2. docs/Q_PORTFOLIO_REDESIGN_MASTER_AUDIT.md
"""

import os
import sys

DESKTOP_PATH = "/Users/q/Desktop/Q_PORTFOLIO_REDESIGN_MASTER_AUDIT.md"
WORKSPACE_PATH = "/Users/q/workspace/q-portfolio/docs/Q_PORTFOLIO_REDESIGN_MASTER_AUDIT.md"

def build_audit_markdown():
    return """# Q PORTFOLIO REDESIGN & EVOLUTION MASTER AUDIT
...
def main():
    ...
    # 1. Write to Desktop
    print(f"Writing audit to Desktop: {DESKTOP_PATH}")
    with open(DESKTOP_PATH, "w", encoding="utf-8") as f:
        f.write(content)
    print("✓ Successfully written to Desktop.")
    
    # 2. Write to Workspace docs
    os.makedirs(os.path.dirname(WORKSPACE_PATH), exist_ok=True)
    print(f"Writing audit to Workspace: {WORKSPACE_PATH}")
    with open(WORKSPACE_PATH, "w", encoding="utf-8") as f:
        f.write(content)
    print("✓ Successfully written to Workspace docs.")
    
    print(f"\nDocument Size: {len(content.encode('utf-8'))} bytes, {len(content.splitlines())} lines.")
